      ...
      <div className="flex flex-col md:flex-row justify-center items-center mx-2 sm:mx-5 lg:mx-10">
        <div className="self-center mx-10 md:pl-5 lg:mx-5 lg:pl-20">
          <h2 className="text-center md:text-start pt-5 md:pt-0 text-main-color">
            If you want more information about me or my work, don't hesitate to
            contact me with this contact form or directly on my email address.{" "}
          </h2>
        ...
        <div>
          ...
          >
            <div className="flex flex-col lg:flex-row lg:gap-5">
              <div className="flex flex-col sm:gap-1 sm:mb-8 mb-2">
                <label className="mb-1 font-semibold text-main-color">
                  Name <span className="text-red-element">*</span> :{" "}
                </label>
                <input
                  type="text"
                  placeholder="Name"
              ...
              <div className="flex flex-col sm:gap-1 sm:mb-8 mb-2">
                <label className="mb-1 font-semibold text-main-color">
                  Email <span className="text-red-element">*</span> :{" "}
                </label>
                <input
                  type="email"
                  required
            ...
            <div className="flex flex-col sm:gap-1 sm:mb-8 mb-2">
              <label className="mb-1 font-semibold text-main-color">
                Message <span className="text-red-element">*</span> :{" "}
              </label>
              <textarea
                cols="30"
                rows="4"
