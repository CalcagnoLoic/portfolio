...
const Contact = () => {
    ...
    return (
        <div className="pb-8 ">
            <h2 id="contact" className="text-center text-dark-blue pt-10 text-3xl lg:text-4xl font-bold">Contact</h2>
