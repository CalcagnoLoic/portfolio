    ...
    return (
        <nav className="flex flex-col py-6 pl-28 pr-28 justify-between xl:flex-row bg-dark-blue">
            ...
            <div className="flex gap-16 self-center mt-5 mb-5 lg:my-5 md:my-5 sm:my-5"> 
                <a className="text-white text-[18px] sm:text-xl xl:text-xl md:text-xl hover:cursor-pointer hover:italic xl:hover:underline hover:underline-offset-[10px]" href='#tech' rel="noreferrer">Technologies</a>
                <p className="text-white text-[18px] sm:text-xl xl:text-xl md:text-xl hover:cursor-pointer hover:italic xl:hover:underline hover:underline-offset-[10px]">Projets</p>
                <p className="text-white text-[18px] sm:text-xl xl:text-xl md:text-xl hover:cursor-pointer hover:italic xl:hover:underline hover:underline-offset-[10px]">Contact</p>
            </div>
